...
namespace Data.Eval.Invocation.Expressions
{
	internal sealed class ExecuteInstanceMethodExpression
	{
			...
			string methodName)
		{
			...
			Expression methodExp = Expression.Call(Expression.Convert(instance, instanceType), method, new Expression[] { });
			...
			Expression<Func<object, object[], object>> methodCall = Expression.Lambda<Func<object, object[], object>>(methodExp, instance, allParameters);
		...
		public Action<object, object[]> GetFuncWithNoReturn(Type instanceType, string methodName)
		{
			MethodInfo method = instanceType.GetMethod(methodName);
			...
			Expression<Action<object, object[]>> methodCall = Expression.Lambda<Action<object, object[]>>(methodExp, instance, allParameters);
